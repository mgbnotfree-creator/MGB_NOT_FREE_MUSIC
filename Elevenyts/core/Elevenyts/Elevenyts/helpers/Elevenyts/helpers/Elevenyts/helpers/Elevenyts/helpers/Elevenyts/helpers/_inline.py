...
from Elevents import app, config, lang
...
class Inline:
    ...
    def help_markup(
        ...
        if back:
            ...
            rows = [
                ...
                [
                    self.ikb(text="Bl Chat", callback_data="help_blchat", style=ButtonStyle.PRIMARY),
                    self.ikb(text="Bl User", callback_data="help_bluser", style=ButtonStyle.PRIMARY),
                ...
                [
                    ...
                    self.ikb(text="🌐 Languages", callback_data="help_langs", style=ButtonStyle.DANGER),
                ]
            ]
    ...
    def play_queued(
        ...
        return self.ikm(
            [
                ...
                [
                    self.ikb(text="Auto", callback_data=f"controls autoplay {chat_id}", style=ButtonStyle.SUCCESS),
                    self.ikb(text="🗑️", callback_data=f"controls close {chat_id}", style=ButtonStyle.DANGER),
                ]
            ]
        )
    ...
    def start_key(
        ...
        rows = [
            ...
            [
                ...
                self.ikb(text="🌐 Languages", callback_data="help_langs", style=ButtonStyle.PRIMARY),
            ],
            [
    ...
    def yt_key(self, link: str) -> types.InlineKeyboardMarkup:
        return self.ikm(
            [
                [
                    self.ikb(text="📥 YouTube Audio", copy_text=link, style=ButtonStyle.PRIMARY),
