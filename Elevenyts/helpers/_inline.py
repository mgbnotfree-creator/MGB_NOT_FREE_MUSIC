...
class Inline:
    ...
    def cancel_dl(self, text) -> types.InlineKeyboardMarkup:
        return self.ikm([[self.ikb(text=text, callback_data="cancel_dl", style=ButtonStyle.PRIMARY)]])
    ...
    def controls(
        ...
        if not remove:
            # Compact current-song controls. Keep the status/time row above unchanged.
            keyboard.append([
    ...
    def help_markup(
        ...
        if back:
            rows = [
                [
                    self.ikb(text="🔙 Back", callback_data="help_main", style=ButtonStyle.SUCCESS),
                ]
            ]
        else:
            ...
            rows = [
                [
                    self.ikb(text="🛠 Admins", callback_data="help_admins", style=ButtonStyle.PRIMARY),
                ...
                [
                    self.ikb(text="🚫 BlChat", callback_data="help_blchat", style=ButtonStyle.PRIMARY),
                    self.ikb(text="🚷 BlUser", callback_data="help_bluser", style=ButtonStyle.PRIMARY),
                    self.ikb(text="🌐 Gban", callback_data="help_gban", style=ButtonStyle.PRIMARY),
                ],
                [
                    self.ikb(text="🔂 Loop", callback_data="help_loop", style=ButtonStyle.PRIMARY),
                    self.ikb(text="🎵 Play", callback_data="help_play", style=ButtonStyle.PRIMARY),
                    self.ikb(text="📜 Queue", callback_data="help_queue", style=ButtonStyle.PRIMARY),
                ],
                [
                    self.ikb(text="⏱ Seek", callback_data="help_seek", style=ButtonStyle.PRIMARY),
                    self.ikb(text="🔀 Shuffle", callback_data="help_shuffle", style=ButtonStyle.PRIMARY),
                    self.ikb(text="🏓 Ping", callback_data="help_ping", style=ButtonStyle.PRIMARY),
                ],
                [
                    self.ikb(text="📊 Stats", callback_data="help_stats", style=ButtonStyle.PRIMARY),
                    self.ikb(text="👑 Sudo", callback_data="help_sudo", style=ButtonStyle.PRIMARY),
                    self.ikb(text="🛠 Maintenance", callback_data="help_maintenance", style=ButtonStyle.PRIMARY),
                ],
                [
                    self.ikb(text="🏠 Home", callback_data="start", style=ButtonStyle.SUCCESS),
                    self.ikb(text="🌐 Change Language", callback_data="help_langs", style=ButtonStyle.DANGER),
                ]
            ]
    ...
    def langs_markup(self) -> types.InlineKeyboardMarkup:
        ...
        for i in range(0, len(langs), 2):
            ...
            rows.append(row)
        rows.append([self.ikb(text="🔙 Back", callback_data="help", style=ButtonStyle.SUCCESS)])
        return self.ikm(rows)
        ...
        return self.ikm(
            [
                [
                    ...
                    self.ikb(
                        text="⏸️ ⏸️", callback_data=f"controls pause {chat_id}", style=ButtonStyle.PRIMARY),
                    self.ikb(
                        text=">>", callback_data=f"controls skip {chat_id}", style=ButtonStyle.PRIMARY),
                    self.ikb(
                        text="⏹️", callback_data=f"controls stop {chat_id}", style=ButtonStyle.DANGER),
                ],
                [
                    self.ikb(
                        text="Auto", callback_data=f"controls autoplay {chat_id}", style=ButtonStyle.SUCCESS),
                    self.ikb(
                        text="🗑️", callback_data=f"controls close {chat_id}", style=ButtonStyle.DANGER),
                ]
            ]
        )
    ...
    def yt_key(self, link: str) -> types.InlineKeyboardMarkup:
        return self.ikm(
            [
                [
                    self.ikb(text="🔗 Open Video URL", copy_text=link, style=ButtonStyle.PRIMARY),
