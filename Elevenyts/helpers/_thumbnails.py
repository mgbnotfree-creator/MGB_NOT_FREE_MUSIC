...
def _render(art: Image.Image, title: str, artist: str,
    ...
    # MGB NOT FREE pill
    _glass_pill(canvas, W-165, 30, 180, 32, r=16,
                tint_alpha=16, border_alpha=80, shine_alpha=55)
    d = ImageDraw.Draw(canvas, "RGBA")
    d.text((W-245, 14), "MGB NOT FREE", font=_font(19, bold=True), fill=WHITE)
    d.text((W-65,  18), "🔔",           font=_font(18),            fill=LGRAY)
    d.text((W-35,  18), "···",          font=_font(18, bold=True), fill=LGRAY)
