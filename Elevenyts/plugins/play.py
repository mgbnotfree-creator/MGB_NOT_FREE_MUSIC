...
async def play_hndlr(
    ...
    if cplay:
        ...
        if channel_id is None:
            return await safe_reply(m,
                "<blockquote>⚠️ Channel play is not enabled.\n\n"
        ...
        try:
            ...
            return await safe_reply(m,
                "<blockquote>⚠️ Cannot find channel!\n\n"
            ...
            try:
                ...
                if chat.username:
                    ...
                    try:
                        ...
                        return await safe_reply(m,
                            f"<blockquote>⚠️ Assistant cannot join channel!\n\n"
                ...
                error_str = str(e)
                return await safe_reply(m,
                    f"<blockquote>⚠️ Failed to join assistant to channel!\n\n"
    ...
    if media:
        ...
        if "playlist" in url:
            ...
            try:
                ...
                await safe_edit(
                    sent,
                    "<blockquote>⚠️ Failed to fetch playlist.\n\n"
                    "YouTube playlists are currently experiencing issues. "
                    "Please try a single track instead.</blockquote>"
                )
                return
    ...
    if not file.file_path:
        await safe_edit(
            sent,
            "<blockquote>⚠️ Failed to stream media.\n\n"
            "Possible reasons:\n"
    ...
    try:
        ...
        if "bot" in error_msg.lower() or "sign in" in error_msg.lower():
            await safe_edit(
                sent,
                "<blockquote>⚠️ YouTube bot detection triggered.\n\n"
                "Solution:\n"
